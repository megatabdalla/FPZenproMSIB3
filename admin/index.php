...
<body>
    ...
    <br>
    <div class="container">
        <p style="margin-left: 105px;"><a href="admin_tambah.php" style="color: #348898;"><button type="button">Tambah Admin</a></button></p>
        <table width="900" cellpadding="5" cellspacing="0" class="center">
            ...
            while ($data = mysqli_fetch_array($hasil))
            {
                ...
                <tr>
                    ...
                    <td align="center">
                        <a href="edmin.php?username=<?php echo $data['username'];?>" class="button" style="color: #348898;"><button type="button" style="margin-right: 15px;">Edit</a></button>
                        <a href="delmin.php?username=<?php echo $data['username'];?>" class="button" style="color: #348898;"><button type="button">Delete</a></button>
                    </td>
                </tr>
                <?php 
                $no++;
